...
/*namespace _5951071004_NgoVanChien
{
    public partial class Form1 : Form
    {
        ...
        void ketnoi()
        {
            string s = @"Data Source=DESKTOP-ALRJ4QO\SQLEXPRESS;Initial Catalog=DemoCRUD1;Integrated Security=True";
        ...
        void loaddata()
        {
            string s = "select * from StudentsTb";
...
namespace _5951071004_NgoVanChien
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-ALRJ4QO\SQLEXPRESS;Initial Catalog=DemoCRUD1;Integrated Security=True");
        ...
        private object StudentRecordData;
